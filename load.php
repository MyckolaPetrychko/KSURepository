<?php
				...
				$i = 1;
				while(file_exists("01.05.02/$i.html")){
					$Vern->parse("01.05.02/$i.html", $pdo, "repo_nbuv_math");
					$i++;
				}
				$i = 1;
				while(file_exists("05.13.06/$i.html")){
					$Vern->parse("data/nbuv/05.13.06/$i.html", $pdo,  "repo_nbuv_intelligence");
					$i++;
				}
				$i = 1;
				while(file_exists("data/nbuv/05.13.23/$i.html")){
					$Vern->parse("data/nbuv/05.13.23/$i.html", $pdo, "repo_nbuv_it");
					$i++;
				}
